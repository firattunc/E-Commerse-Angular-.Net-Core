...
namespace Ecommerse.Migrations
{
    ...
    [Migration("20200729103239_product-category1")]
    partial class productcategory1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerse.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ecommerse.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Ecommerse.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Ecommerse.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Ecommerse.Entities.Product", b =>
                {
                    b.HasOne("Ecommerse.Entities.Category", "Category")
                        .WithMany()
