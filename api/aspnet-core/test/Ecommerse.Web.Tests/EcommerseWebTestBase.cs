...
{
    public abstract class EcommerseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EcommerseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EcommerseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EcommerseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EcommerseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EcommerseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EcommerseDbContext, Task<T>> func)
        {
            T result;
