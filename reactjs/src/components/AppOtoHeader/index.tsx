            ...
            <div className="col-lg-6 text-center text-lg-right">
              <ul className="menu list-inline mb-0">
              {
                this.props.authenticationStore!.isAuthenticated?(
                  ...
                  <Link to="/appoto/customerlogin">Login</Link>
                </li>
                <li className="list-inline-item">
                  <Link to="/appoto/customerregister">Register</Link>
                </li>
                </>
                )} 
          ...
          <div id="navigation" className="collapse navbar-collapse">
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item dropdown menu-large">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" className="dropdown-toggle nav-link">
